...
var Direction = /** @class */ (function () {
  ...
  Direction.from = function (dx, dy) {
    ...
    try {
      for (
        var _b = __values(this.all()), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
        var dir = _c.value;
...
var Block = /** @class */ (function () {
  ...
  Block.prototype.containsCoord = function (x, y) {
    ...
    try {
      for (
        var _b = __values(this.shapeCoords()), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
  ...
  Block.prototype.overlapsWith = function (other, dx, dy) {
    ...
    try {
      for (
        var _c = __values(this.shapeCoords()), _d = _c.next();
        !_d.done;
        _d = _c.next()
      ) {
        ...
        try {
          for (
            var _f = ((e_3 = void 0), __values(other.shapeCoords())),
              _g = _f.next();
            !_g.done;
            _g = _f.next()
          ) {
...
var Board = /** @class */ (function () {
  ...
  Board.prototype.savePositions = function () {
    ...
    try {
      for (
        var _b = __values(this.blocks), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
        var block = _c.value;
  ...
  Board.prototype.findBlock = function (nameOrPredicate) {
    ...
    if (typeof nameOrPredicate === "string") {
      ...
      try {
        for (
          var _c = __values(this.blocks), _d = _c.next();
          !_d.done;
          _d = _c.next()
        ) {
          var block = _d.value;
      ...
      try {
        for (
          var _e = __values(this.blocks), _f = _e.next();
          !_f.done;
          _f = _e.next()
        ) {
          var block = _f.value;
...
var CanvasRenderer = /** @class */ (function () {
  ...
  CanvasRenderer.prototype.render = function () {
    ...
    try {
      for (
        var _b = __values(this.board.blocks), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
        var block = _c.value;
  ...
  CanvasRenderer.prototype.renderBlock = function (block) {
    ...
    if (block.color) {
      ...
      try {
        for (
          var _b = __values(block.shapeCoords()), _c = _b.next();
          !_c.done;
          _c = _b.next()
        ) {
          var _d = __read(_c.value, 2),
...
var HTMLRenderer = /** @class */ (function () {
  function HTMLRenderer(_a) {
    ...
    try {
      // Blocks
      for (
        var _e = __values(board.blocks), _f = _e.next();
        !_f.done;
        _f = _e.next()
      ) {
        var block = _f.value;
...
export { Block, Board, CanvasRenderer, Direction, HTMLRenderer };
