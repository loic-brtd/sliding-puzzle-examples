(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var Board = /** @class */ (function () {
        ...
        Board.prototype.findBlocksByTag = function (tag) {
            return this.blocks.filter(function (b) { return b.tag === tag; });
        };
    ...
    var HTMLRenderer = /** @class */ (function () {
        function HTMLRenderer(_a) {
            var e_1, _b;
            var _this = this;
            var board = _a.board, parentElement = _a.parentElement, proportions = _a.proportions, backgroundImage = _a.backgroundImage;
            ...
            try {
                // Blocks
                for (var _c = __values(board.blocks), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var block = _d.value;
