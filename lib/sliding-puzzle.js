(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.SlidingPuzzle = {}));
    ...
    ***************************************************************************** */
    ...
    var Block = /** @class */ (function () {
        function Block(_a) {
            var _b = _a === void 0 ? {} : _a, _c = _b.shape, shape = _c === void 0 ? [[1]] : _c, _d = _b.x, x = _d === void 0 ? 0 : _d, _e = _b.y, y = _e === void 0 ? 0 : _e, _f = _b.possibleMoves, possibleMoves = _f === void 0 ? Direction.all() : _f, _g = _b.possibleOverlaps, possibleOverlaps = _g === void 0 ? [] : _g, _h = _b.selectable, selectable = _h === void 0 ? true : _h, color = _b.color, image = _b.image, name = _b.name, content = _b.content;
            this.shape = [[1]];
            this.cols = 0;
            this.rows = 0;
            this.shape = shape;
            this.cols = this.shape.reduce(function (acc, curr) { return Math.max(acc, curr.length); }, 0);
        ...
        Block.prototype.containsCoord = function (x, y) {
            var e_1, _a;
            try {
                for (var _b = __values(this.shapeCoords()), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var _d = __read(_c.value, 2), bx = _d[0], by = _d[1];
                    if (x === bx && y === by) {
                        return true;
                    }
                }
        ...
        Block.prototype.overlapsWith = function (other, dx, dy) {
            ...
            if (dy === void 0) { dy = 0; }
            try {
                for (var _c = __values(this.shapeCoords()), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var _e = __read(_d.value, 2), x = _e[0], y = _e[1];
                    try {
                        for (var _f = (e_3 = void 0, __values(other.shapeCoords())), _g = _f.next(); !_g.done; _g = _f.next()) {
                            var _h = __read(_g.value, 2), ox = _h[0], oy = _h[1];
                            if (x === ox + dx && y === oy + dy) {
                                return true;
                            }
                        }
    ...
    function runAnimation(_a) {
        ...
        var _b = _a === void 0 ? {} : _a, _c = _b.duration, duration = _c === void 0 ? 100 : _c, _d = _b.timingFunction, timingFunction = _d === void 0 ? function (t) { return t; } : _d, onFrame = _b.onFrame, onEnd = _b.onEnd;
        var startTime;
    ...
    var Board = /** @class */ (function () {
        function Board(_a) {
            var _b = _a === void 0 ? {} : _a, _c = _b.cols, cols = _c === void 0 ? 6 : _c, _d = _b.rows, rows = _d === void 0 ? 6 : _d, _e = _b.animate, animate = _e === void 0 ? true : _e, _f = _b.animationDuration, animationDuration = _f === void 0 ? 60 : _f, color = _b.color, image = _b.image;
            this.blocks = [];
            this._callbacks = new Map(CALLBACK_NAMES.map(function (name) { return [name, []]; }));
        ...
        Board.prototype.restorePositions = function () {
            ...
            try {
                for (var _b = __values(this.blocks), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var block = _c.value;
                    var _d = this._savedPositions.get(block), x = _d.x, y = _d.y;
        ...
        Board.prototype.findBlock = function (nameOrPredicate) {
            ...
            if (typeof nameOrPredicate === "string") {
                ...
                try {
                    for (var _c = __values(this.blocks), _d = _c.next(); !_d.done; _d = _c.next()) {
                        var block = _d.value;
                        if (block.name === name_1)
                            return block;
                    }
                }
                catch (e_3_1) { e_3 = { error: e_3_1 }; }
                ...
                try {
                    for (var _e = __values(this.blocks), _f = _e.next(); !_f.done; _f = _e.next()) {
                        var block = _f.value;
                        if (predicate(block))
                            return block;
                    }
        ...
        Board.prototype.on = function (event, callback) {
            ...
            if (!CALLBACK_NAMES.includes(event)) {
                console.error("'" + event + "' is not an event of the Board class. " +
                    ("Valid events are: " + CALLBACK_NAMES.map(function (n) { return "\"" + n + "\""; }).join(", ") + "."));
                return;
            }
            this._callbacks.get(event).push(callback);
        };
        Board.prototype._fireEvent = function (event, block) {
            this._callbacks.get(event).forEach(function (cb) { return cb(block); });
        };
        ...
        Board.prototype.tryMoveSelectedBlock = function (direction) {
            ...
            if (this.animate) {
                // With animation
                var _d = this.selectedBlock, x_1 = _d.x, y_1 = _d.y;
    ...
    var CanvasRenderer = /** @class */ (function () {
        function CanvasRenderer(_a) {
            var board = _a.board, canvas = _a.canvas, dimension = _a.dimension;
            this.board = board;
            if (!canvas && !dimension) {
        ...
        CanvasRenderer.prototype.render = function () {
            ...
            try {
                for (var _b = __values(this.board.blocks), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var block = _c.value;
        ...
        CanvasRenderer.prototype.renderBlock = function (block) {
            ...
            if (block.color) {
                var inside = unit * 0.8;
                try {
                    for (var _b = __values(block.shapeCoords()), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    var HTMLRenderer = /** @class */ (function () {
        function HTMLRenderer(_a) {
            var e_1, _b;
            var _this = this;
            var board = _a.board, _c = _a.container, container = _c === void 0 ? document.body : _c, _d = _a.proportions, proportions = _d === void 0 ? { x: 0, y: 0, width: 1, height: 1 } : _d, backgroundImage = _a.backgroundImage;
            ...
            try {
                // Blocks
                for (var _e = __values(board.blocks), _f = _e.next(); !_f.done; _f = _e.next()) {
                    var block = _f.value;
        ...
        HTMLRenderer.prototype.onMousePressed = function (callback) {
            ...
            var handler = function (e) {
                ...
                var _a = _this._callbackMouseCoord(e), x = _a.x, y = _a.y;
                callback(x, y);
            };
        ...
        HTMLRenderer.prototype.onMouseReleased = function (callback) {
            ...
            document.body.addEventListener("mouseup", function (e) { return handler(e); });
            document.body.addEventListener("touchend", function (e) { return handler(e); });
        };
